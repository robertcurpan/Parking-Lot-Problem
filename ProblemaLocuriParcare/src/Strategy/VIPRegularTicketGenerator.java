...
public class VIPRegularTicketGenerator implements TicketGenerator
{
    ...
    public ArrayList<Integer> getTicket(ArrayList<ParkingSpot>[] parkingSpots, int vehicleTypeId)
    {
        ...
        {
            idSpot = findEmptyNonElectricSpotOnCurrentCategory(parkingSpots, vehicleTypeId);
    ...
    public int findEmptyNonElectricSpotOnCurrentCategory(ArrayList<ParkingSpot>[] parkingSpots, int vehicleTypeId)
    {
