...
public class VIPRegularTicketGenerator implements TicketGenerator
{
    ...
    public ParkingSpotIdAndVehicleTypeId getTicket(ArrayList<ParkingSpot>[] parkingSpots, ArrayList<Integer> nrEmptySpots, HashMap<Integer, Driver> drivers, Driver d, int vehicleTypeId) throws ParkingSpotNotFoundException
    {
        ...
        {
            idSpot = findEmptyNonElectricSpotOnCurrentCategory(parkingSpots, nrEmptySpots, drivers, d, vehicleTypeId);
    ...
    public int findEmptyNonElectricSpotOnCurrentCategory(ArrayList<ParkingSpot>[] parkingSpots, ArrayList<Integer> nrEmptySpots, HashMap<Integer, Driver> drivers, Driver d, int vehicleTypeId)
    {
